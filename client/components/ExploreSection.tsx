  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 w-full max-w-[360px] p-10 rounded-[10px] border border-white/20 bg-[#0D0D0D]">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <div className={`font-roboto font-normal text-[45px] leading-[52px] text-center ${color}`}>
          {value}
        </div>
        <div className="font-inter font-bold text-base leading-[23px] tracking-[-0.16px] text-white text-center max-w-[319px]">
          {description}
        </div>
      </div>
    </div>
...
export default function ExploreSection() {
  ...
  return (
    <section id="explore" className="relative w-full bg-black py-20">
      ...
      <div className="relative z-10 container mx-auto px-11 max-w-7xl">
        <div className="flex flex-col items-center gap-16">
          {/* Header */}
          <div className="flex flex-col items-center gap-5 text-center">
            <h2 className="font-dm-sans font-bold text-[54px] leading-[60px] tracking-[-3.24px]">
              <span className="text-white">Explore </span>
              <span className="text-brand-purple">StroomUp</span>
            </h2>
            
            <div className="font-inter text-[22px] leading-[31px] tracking-[-0.792px] text-white max-w-[974px]">
          ...
          <div className="flex flex-col items-center gap-8 w-full">
            <h3 className="font-dm-sans font-bold text-[54px] leading-[60px] tracking-[-3.24px] text-center">
